...
class AtlasPilotWindow(QMainWindow):
    def __init__(self) -> None:
        ...
        self.pages: dict[str, QWidget] = {
            ...
            "tds-diagnostics": TdsDiagnosticsWorkspace(),
            "network-audit": NetworkAuditWorkspace(),
    ...
    def _build_navigation(self) -> QWidget:
        ...
        self._add_nav_button(layout, "TDS Diagnostics", "tds-diagnostics")
        self._add_nav_button(layout, "Network Audit", "network-audit")
