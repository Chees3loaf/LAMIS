...
VIAddVersionKey /LANG=${LANG_ENGLISH} "CompanyName"      "ZeroToil"
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription"  "Automated Toolkit for LightRiver Asset & Systems"
VIAddVersionKey /LANG=${LANG_ENGLISH} "LegalCopyright"   "Copyright (C) 2024-2026 ZeroToil. All rights reserved."
...
Section "Install ATLAS"
    ...
    WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Uninstall\ATLAS" "Publisher"       "ZeroToil"
